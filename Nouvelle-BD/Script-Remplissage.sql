...
WHERE IDEVALUATION IS NOT NULL AND IDEVALUATION NOT IN (SELECT DISTINCT IDEVALUATION FROM FIEVETL.NOTES_DATA MINUS SELECT DISTINCT IDEVALUATION FROM FIEVETL.EVALUATIONS);
commit;
