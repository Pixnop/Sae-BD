...
FROM fievetl.COURS_ENSEIGNANTS_DATA
WHERE IDENSEIGNANTRESPONSABLE IN (SELECT DISTINCT IDENSEIGNANTRESPONSABLE FROM fievetl.COURS_ENSEIGNANTS_DATA MINUS SELECT DISTINCT IDENSEIGNANTRESPONSABLE FROM fievetl.Utilisateurs)
...
FROM FIEVETL.COURS_ENSEIGNANTS_DATA
WHERE IDINTERVENANT IN (SELECT DISTINCT IDINTERVENANT FROM FIEVETL.COURS_ENSEIGNANTS_DATA MINUS SELECT DISTINCT IDINTERVENANT FROM fievetl.Utilisateurs)
